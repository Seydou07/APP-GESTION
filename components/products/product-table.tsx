...
import { Plus, Search, Pencil, Trash2, AlertTriangle, ArrowUpAZ, ArrowDownZA, ChevronsUpDown, Truck } from "lucide-react"
                        ...
                        {loading ? (
                            ...
                            <TableRow key={product.id}>
                                <TableCell className="font-medium">
                                    ...
                                    {product.code && <p className="text-xs text-muted-foreground font-mono">{product.code}</p>}
                                </TableCell>
                                <TableCell className="font-mono">{product.salePrice.toLocaleString()} F</TableCell>
                                <TableCell>
                                    <span className={cn(
                                ...
                                <TableCell className="text-right space-x-1">
                                    <Button
                                        ...
                                        className={cn(
                                            ...
                                            (product.stockLevels?.find((sl: any) => sl.warehouseId === 2)?.quantity ?? 0) <= 0 && "opacity-40"
                                        )}
                                    >
                                    ...
                                    <Button variant="ghost" size="icon" onClick={() => { setProductToDelete(product.id); setIsConfirmOpen(true) }} className="rounded-full text-destructive hover:text-destructive hover:bg-destructive/10">
