...
export default function UsersPage() {
    ...
    const filteredUsers = users.filter((u: any) => {
        ...
        const pseudoLower = (u.pseudo ?? "").toLowerCase()
        const emailLower = (u.email ?? "").toLowerCase()
        
        return pseudoLower.includes(searchLower) || emailLower.includes(searchLower)
    })
                            ...
                            <div className="grid gap-2">
                                ...
                                >
                                    ...
                                    <SelectContent className="rounded-xl">
                                        ...
                                        <SelectItem value="VENDEUR">Vendeur (Point de vente)</SelectItem>
                                        <SelectItem value="COMPTABLE">Comptable (Factures, dépenses)</SelectItem>
                                        <SelectItem value="STOCK_MANAGER">Stock Manager (Inventaire)</SelectItem>
                                        <SelectItem value="ACHETEUR">Acheteur (Achats, fournisseurs)</SelectItem>
                                    </SelectContent>
                                </Select>
                            </div>
