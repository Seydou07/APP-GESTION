        ...
        <div className="space-y-8 pb-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-background p-6 rounded-3xl border shadow-sm space-y-2">
                    ...
                    <p className="text-xs font-bold text-muted-foreground uppercase tracking-widest">Total Dépenses</p>
                    <h3 className="text-2xl font-black">{totalExpenses.toLocaleString()} F</h3>
                </div>
            </div>
